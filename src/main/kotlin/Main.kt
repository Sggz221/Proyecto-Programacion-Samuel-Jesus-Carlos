...
fun main() {
    ...
    val j1 = Jugador(0, "", "Pepe", LocalDate.now(), LocalDate.now(), 11.0, "Pepe", LocalDateTime.now(), LocalDateTime.now(),false, DelanteroImpl(), 1, 11.0, 11.0, 1, 1)
    val e1 = Entrenador(0, "Pepe", "Pepe", LocalDate.now(), LocalDate.now(), 11.0, "Pepe", LocalDateTime.now(), LocalDateTime.now(),false, EntrenadorPrincipalImpl())
